export const servicesData = {
  'roof-installation': {
    ...
    benefitsOFChoosing : [
      {
        title: 'Enhanced Home Protection',
        description: 'Our expert roof installations shield your home from Florida’s harsh sun, heavy rains, and strong winds, ensuring year-round safety.'
      },
      {
        title: 'Improved Energy Efficiency',
        description: 'High-quality roofing materials reduce heat absorption, lowering your energy bills and keeping your home cooler.'
      },
      {
        title: 'Long-Lasting Durability',
        description: 'We use premium roofing products designed to withstand Florida’s climate, providing decades of reliable protection.'
      },
      {
        title: 'Boosted Property Value',
        description: 'A professionally installed roof increases your home’s market value and curb appeal, making it a smart investment.'
      },
      {
        title: 'Storm & Hurricane Resistance',
        description: 'Our roofing systems meet Florida building codes for wind resistance, giving you peace of mind during hurricane season.'
      },
      {
        title: 'Warranty & Guaranteed Quality',
        description: 'Every roof installation comes with strong warranties and our Total Care commitment to excellence.'
      },
      {
