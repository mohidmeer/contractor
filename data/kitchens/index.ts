...
export const aboutPage = {
    ...
    content: 'Total Care Kitchens is your go-to team for expert kitchen renovations. From concept to completion, we deliver custom designs, premium finishes, and seamless service to elevate your homeâ€™s heart.',
}
...
export const getToKnow = {
    ...
    description:
        'Total Care Kitchens is your trusted partner for transforming kitchens into stunning, functional spaces. We combine expert craftsmanship, modern design, and respectful service to deliver kitchens youâ€™ll love.',
    keyPoints: [
        {
...
export const servicesData = {
    ...
    'kitchen-plumbing': {
        ...
        content: `Total Care kitchens brings the same trusted expertise in plumbing to your kitchen renovations. Whether youâ€™re replacing an old sink or reconfiguring your entire kitchen layout, our licensed professionals handle every detail with precision. We install and connect sinks, faucets, garbage disposals, and dishwashers while ensuring your plumbing system is leak-free and compliant with local codes. From basic hook-ups to complete re-routing of water lines, we prioritize functionality, cleanliness, and longevity in every installation.`,
...
export const projectsData = {
  ...
  `,
    ...
    "farmhouse-kitchen": {
        ...
        content: `
  This renovation brought farmhouse charm to life in a cozy countryside home. The homeowners envisioned a warm and welcoming kitchen that honored traditional design while integrating modern conveniences â€” and Total Care kitchens delivered just that.
  ...
  `,
    ...
    "family-kitchen": {
        ...
        content: `
  Designed for a busy family in Winter Garden, this kitchen makeover by Total Care kitchens prioritized function, safety, and a warm, inviting atmosphere. The layout was optimized for meal prep, school lunches, and family dinnersâ€”all in one flexible space.
...
export const testimonialsData = [
...

    {
        ...
        "feedback": "Our old kitchen was cramped and dated. Total Care Kitchens opened up the space beautifully â€” it now feels like the heart of our home.",
    },
