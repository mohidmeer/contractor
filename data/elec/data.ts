...
export const navItems = [
    ...
    },
    {
      ...
      children: [
        ...
        { label: 'Heritage Hotel Power Renovation', href: '/projects/heritage-hotel-renovation', hasChildrens: false },
...
export const projectsData = {
    ...
    'heritage-hotel-renovation': {
      label: 'Heritage Hotel Power Renovation',
      title: 'Heritage Hotel Power Renovation Project',
      ...
      content: `
    For the Heritage Hotel, our team was tasked with a sensitive power system upgrade that respected the building’s vintage charm while meeting modern electrical standards.
    ...
    'green-grove-setup': {
      label: 'Green Grove Electrical Setup',
      title: 'Green Grove Villas Electrical Installation',
      description: 'Full electrical installation for a new residential development, focused on safety, efficiency, and smart living integration.',
      image: `/images/projects/default.jpg`,
      location: 'Orlando, FL',
      duration: 'Completed in 3 weeks',
      materials: [
        ...
        'GFCI & AFCI Breakers',
        'EV Charger Ready Outlets',
        'Low-Voltage Prewiring',
        'Cat6 Cabling',
        'Motion Sensors'
      ],
      content: `
    Green Grove Villas was a new development consisting of multiple single-family homes.
    Our task was to deliver a complete and future-ready electrical system in each unit.
    We installed copper wiring throughout, with panels supporting both traditional and smart home features.
    Each home received prewiring for EV charging, smart lighting, and internet connectivity.
    Emphasis was placed on energy-efficient fixtures and safety-first configurations, making each home both modern and reliable.`,
      images: ['/projects/default.jpg', '/projects/default.jpg', '/projects/default.jpg', '/projects/default.jpg']
    },
    'ocean-bay-energy': {
      label: 'Ocean Bay Resort Energy Design',
      title: 'Ocean Bay Resort Electrical & Energy Optimization',
      description: 'Comprehensive electrical system and energy-efficient design for a luxury beachfront resort.',
      image: `/images/projects/default.jpg`,
      location: 'Ocean Bay, FL',
      duration: 'Completed in 5 weeks',
      materials: [
      ...
      content: `
    Ocean Bay Resort needed a high-capacity, energy-efficient electrical system to power its full-service operations.
    We implemented a three-phase system to support commercial loads, with integrated solar backup and generator support.
    Intelligent energy monitoring panels were installed to help reduce long-term costs.
    Specialized wiring was laid out for spa, pool, and beachfront lighting zones.
    Each guest room was equipped with automation-ready panels to allow for future smart upgrades.
    The result was a sleek, high-performance system tailored to a high-end hospitality experience.`,
      images: ['/projects/default.jpg', '/projects/default.jpg', '/projects/default.jpg', '/projects/default.jpg']
    },
