...
export const landingPage = {
  seo: {
    ...
    description: 'Independent Florida roof consulting: evaluations, forensic reports, specs, and construction observationâ€”no installer or manufacturer ties.',
    ogImage: `${static_assets}/images/hero_bg_1.jpg`,
    canonical: siteUrl,
  },
  hero: {
    title: 'Independent Roof Advice Florida Owners Trust',
    description: 'We sell no materials, install no roofs, and represent no contractorsâ€”only your building envelope. You get RRC/RRO-led evaluations, clear reports, and oversight aligned with FBC and hurricane exposure.',
...
export const aboutPage = {
  ...
  content: 'Total Care Roofing is an independent roofing consulting practice serving Florida property owners and managers. Our guidance is shaped only by building science, codes, and your riskâ€”not by material rebates or installer incentives.'
}
export const contactPage = {
  seo: {
    title: 'Contact Us',
    description: 'Contact our Florida roof consultants for scope questions, storm documentation, or peer reviewâ€”education-first, no sales pitch.',
    ogImage: `${static_assets}/images/hero_bg_1.jpg`,
  ...
  keyPoints: [
    {
      ...
      desc: 'No product quotas or subcontractor relationshipsâ€”recommendations follow test evidence, FBC requirements, and your capital plan.'
    },
    {
...
export const faqs = [
  {
    ...
    answer: 'We evaluate existing or planned roof systems, document conditions with photos and testing, and translate findings into reports, details, and observation checkpoints. Our consultants advise owners and counselâ€”not crews swinging hammers.'
  },
  {
    question: 'Do you sell or install roofs?',
    answer: 'No. Selling or installing would compromise the independence you hire us for. Staying out of the supply chain keeps recommendations aligned with building science, insurance needs, and Florida codeâ€”not a material rebate.'
  },
  {
...
export const ourProcessData = {
  ...
  heading: 'Our Process',
  description: 'A consulting workflow built for decisions, documentation, and defensible oversightâ€”not sales-driven installs.',
  list: [
    {
    ...
    },
    {
      ...
      description: 'We pre-qualify bidders, level proposals, and flag scope gaps before you execute contractsâ€”still without taking subcontractor fees.',
      icon: FaHammer
    },
    {
...
export const WhyUSData = [
  {
    ...
    description: 'We carry no inventory, no crews, and no dealer agreementsâ€”only advisory feesâ€”so every call reflects your exposure, not someone elseâ€™s margin.',
    icon: FaUserTie
  },
  {
...
export const FooterData = {
  tagline: 'Independent Florida roof consultants translating field data into clear owner decisionsâ€”without installer bias.'
};
/* ------------------------
   AREAS OF SERVICES
------------------------ */
export const serviceAreasData = [
  ...
  },
  {
    ...
    description:
      "Jacksonville, FL roof asset advisors for mixed portfoliosâ€”inspections, forensic reports, and QA oversight.",
    content: 'Our Florida consultants document membrane and metal conditions, calibrate testing to each microclimate, and keep recommendations free of installer or distributor influence.',
    image: `${static_assets}/images/areaofservices/default.jpg`
  },
  {
    ...
    description:
      "Fort Lauderdale, FL consulting for condos and waterfront assetsâ€”salt air detailing, NOA checks, and RRO logs.",
    content: 'Our Florida consultants document membrane and metal conditions, calibrate testing to each microclimate, and keep recommendations free of installer or distributor influence.',
    image: `${static_assets}/images/areaofservices/default.jpg`
  },
  {
  ...
  },
  {
    ...
    description:
      "Tallahassee, FL roof consulting for civic, education, and office assetsâ€”spec peer review and observation notes.",
    content: 'Our Florida consultants document membrane and metal conditions, calibrate testing to each microclimate, and keep recommendations free of installer or distributor influence.',
    image: `${static_assets}/images/areaofservices/default.jpg`
  },
  {
  ...
  },
  {
    ...
    description: "Sarasota, FL independent roof studies for tile, metal, and flat systemsâ€”no distributor relationships.",
    content: 'Our Florida consultants document membrane and metal conditions, calibrate testing to each microclimate, and keep recommendations free of installer or distributor influence.',
    image: `${static_assets}/images/areaofservices/default.jpg`
  },
  {
  ...
  },
  {
    ...
    description:
      "Clearwater, FL roof consulting for hospitality and retailâ€”nighttime IR, impedance grids, and photo logs.",
    content: 'Our Florida consultants document membrane and metal conditions, calibrate testing to each microclimate, and keep recommendations free of installer or distributor influence.',
    image: `${static_assets}/images/areaofservices/default.jpg`
  },
  {
    ...
    description:
      "Boca Raton, FL roof advisors for HOA towersâ€”mock-up review, attachment audits, and closeout punch lists.",
    content: 'Our Florida consultants document membrane and metal conditions, calibrate testing to each microclimate, and keep recommendations free of installer or distributor influence.',
    image: `${static_assets}/images/areaofservices/default.jpg`
  },
  {
...
export const servicesData = {
  'roof-installation': {
    ...
    description: 'Florida-specific drawings and specs that translate wind zones, NOAs, and FBC chapters into contractor-ready packagesâ€”without tying you to a single vendor.',
    content: `Independent consultants draft and peer-review roofing specifications so every bidder prices the same membrane transitions, attachment patterns, and quality assurance holds. We align assemblies with Florida exposure categories, HVHZ detailing where required, and manufacturer NOAs so submittals match the risk you disclosed to insurers and boards. Because we neither sell material nor self-perform installs, the narrative stays centered on your assetâ€™s performance targets and lifecycle budget.`,
    ...
    benefitsOFChoosing: [
      ...
      { title: 'Vendor-Neutral Language', description: 'We specify performance and testingâ€”not hidden brand carve-outs tied to distributor incentives.' },
  ...
  'roof-repair': {
    ...
    description: 'Trace chronic leaks, membrane splits, and wind-driven failures using test cuts, infrared, and moisture gridsâ€”then receive a neutral cause narrative.',
    content: `Forensic consulting isolates whether distress stems from detailing, material drift, or installation variance. Our RRC-led teams pair visual mapping with infrared thermography, impedance testing, and selective test cuts to document wet insulation and breach paths across Floridaâ€™s heat and salt cycles. Findings feed litigation-ready photo logs or board memoranda without steering you toward a preferred repair contractor.`,
    ...
    benefitsOFChoosing: [
      { title: 'Evidence-Based Findings', description: 'Each anomaly is tied to photos, moisture readings, or lab-ready samplesâ€”not guesswork.' },
      ...
      { title: 'Contractor-Agnostic', description: 'No repair rebatesâ€”recommendations follow the failure mechanism we documented.' },
  ...
  'gutters': {
    ...
    content: `RPIC-credentialed pilots capture repeatable flight paths over campuses, condo roofs, and industrial lines without leaning ladders on membrane edges. Imagery integrates with consultant QA notes so attorneys, insurers, and facility teams see the same geometry we reference in written opinions. Drones augmentâ€”not replaceâ€”close-up RRO work, but they accelerate baseline documentation ahead of hurricane season or litigation freezes.`,
  ...
  'roof-inspection': {
    ...
    benefitsOFChoosing: [
      ...
      { title: 'Vendor-Free Priorities', description: 'Rankings follow observed distress, not a contractorâ€™s install calendar.' },
  ...
  'emergency-roof-repair': {
    ...
    description: 'After named wind events, consultants capture uplifted membranes, compromised flashings, and interior water tracks for carriers and counselâ€”without selling tarps.',
  ...
  'shingle-replacement': {
    ...
    description: 'Nighttime infrared thermography paired with impedance grids pinpoints wet insulation so you replace only what scienceâ€”not guessworkâ€”requires.',
  ...
  'skylight-installation': {
    ...
    description: 'Chronologies, depositions, and measured opinions rooted in RRC practiceâ€”without overstating findings beyond the documented record.',
  ...
  'roof-ventilation': {
    ...
    description: 'Annual consulting calendars blend inspections, moisture spot checks, and budget forecasting so envelopes stay ahead of Floridaâ€™s sun-and-storm cycle.',
    content: `Asset management consulting treats each roof as a portfolio line item with defined KPIsâ€”leak response times, warranty expirations, and capital triggers tied to infrared trends. We coordinate third-party contractors only when the plan calls for intervention, while our team maintains the technical ledger. Independence means the program never quietly favors a single rooferâ€™s maintenance ticket book.`,
...
export const projectsData = {
  'lakeview-villas-roofing': {
    ...
    description: 'Independent evaluations for a Miami luxury associationâ€”tile, metal transitions, and attic moisture checks ahead of a phased capital plan.',
    ...
    content: `
        ...
        Deliverables included prioritized repair zones, mock-up requirements, and observation milestonesâ€”without steering the board toward any single bidder.`,
  },
  ...
  'coastal-homes-upgrade': {
    ...
    description: 'Salt-fog exposure analysis for Naples residencesâ€”metal seam leaks traced to detailing, not panel alloy selection.',
    ...
    content: `Homeowners disputed whether standing seam panels failed or whether flashings drove saltwater intrusion during easterly winds.
      ...
      The ten-day investigation ended with repair scopes tied to specific transitionsâ€”no blanket re-roof directive.`,
  },
  ...
  'sunset-condos-retrofit': {
    ...
    description: 'Fort Lauderdale board supportâ€”cool-roof coating vs. overlay analysis plus construction observation for occupied balconies.',
  ...
  'greenwood-retirement-community': {
    ...
    description: 'Multi-building Florida retirement campusâ€”synchronized inspections so clinical operations continued without roofing sales teams onsite.',
  ...
  'palmetto-business-center': {
    ...
    content: `
      ...
      We modeled three approved assemblies, validated contractor pricing assumptions, and observed the winning bidderâ€™s first insulation lift for thickness compliance.
  ...
  'coral-gables-luxury-homes': {
    ...
    content: `
      The ownerâ€™s architect specified imported clay barrels with integrated concealed gutters that had never been built together in a South Florida HVHZ context.
  ...
  'seaside-shopping-plaza': {
    ...
    description: 'Coastal retail plaza in Seasideâ€”consultants leveled bids after engineers found undersized scuppers in legacy drawings.',
...
export const testimonialsData = [
  {
    ...
    feedback: "Their consultant explained infrared results in plain language and never pushed a roofer referralâ€”exactly the independence we needed for a complex tile home.",
  },
  {
    name: "Sarah Smith",
  ...
  },
  {
    ...
    feedback: "Peer review comments on our sheet set were preciseâ€”FBC wind notes, NOA callouts, and flashing fixes we could issue for permit quickly.",
  },
  {
    name: "Emily Johnson",
    role: "Business Owner",
  ...
  },
  {
    ...
    feedback: "Night-shift observation kept our guests safe while the membrane crew worked; daily briefings never felt salesyâ€”just factual QA.",
  },
  {
  ...
  },
  {
    ...
    feedback: "Even though we were the installer, their RRO team was fairâ€”flagged real non-conformance without inventing problems to bill extra hours.",
  },
  {
  ...
  },
  {
    ...
    feedback: "Moisture survey grids showed exactly which deck sections were wetâ€”no blanket tear-off scare tactics from anyone in the chain.",
  }
];